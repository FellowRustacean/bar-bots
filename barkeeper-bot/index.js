...
const { startReminderScheduler } = require('./utils/reminders/reminderScheduler');
...
client.once('clientReady', () => {
  ...
  startOutboxPoller(client, 'barkeeper');
  startInteractionScheduler(client, 'barkeeper');
  startStatusRotator(client, statusMessages);
  startTeamMeetingPoller(client, 'barkeeper');
});
